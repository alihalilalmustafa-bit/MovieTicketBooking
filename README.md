...
## Project Description
A Java-based application for browsing movies, selecting showtimes, and booking tickets.
This project demonstrates OOP principles like **Inheritance**, **Polymorphism**, and **Encapsulation**.
